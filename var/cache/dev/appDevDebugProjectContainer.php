...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('umyFvq6tPD', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0l6GipcwAU', 0, 'ytL4iLvA2lpKP2+tB2melz', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'iutdoua-web.univ-lyon1.fr', 'port' => 3306, 'dbname' => 'p1517880', 'user' => 'p1517880', 'password' => 253884, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\PTUT\\PlatformBundle\\Resources\\config\\doctrine') => 'PTUT\\PlatformBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'PTUT\\PlatformBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('PTUTPlatformBundle' => 'PTUT\\PlatformBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fb5f7aaf6db9f95b3bb26ff7d07617264ab55a78b92e84df7b02ff69dd712613');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('LRT61FMUkO', NULL, 'ytL4iLvA2lpKP2+tB2melz', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '/home'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\PTUT\\PlatformBundle/Resources/views'), 'PTUTPlatform');
        $instance->addPath(($this->targetDirs[3].'\\src\\PTUT\\UserBundle/Resources/views'), 'PTUTUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1234azerty');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GXIN+FbyGG', 0, 'ytL4iLvA2lpKP2+tB2melz', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'projettuteuré', array(0 => 'ROLE_ADMIN')));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'PTUTPlatformBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PTUT\\PlatformBundle'),
                    'namespace' => 'PTUT\\PlatformBundle',
                ),
                'PTUTUserBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PTUT\\UserBundle'),
                    'namespace' => 'PTUT\\UserBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PTUTPlatformBundle' => 'PTUT\\PlatformBundle\\PTUTPlatformBundle',
                'PTUTUserBundle' => 'PTUT\\UserBundle\\PTUTUserBundle',
            ...
            'database_host' => 'iutdoua-web.univ-lyon1.fr',
            'database_port' => 3306,
            'database_name' => 'p1517880',
            'database_user' => 'p1517880',
            'database_password' => 253884,
